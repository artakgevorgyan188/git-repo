...
MySQL - 5.5.48 : Database - yii2_shopper
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`yii2_shopper` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `sh_user`(`id`,`username`,`password`,`auth_key`) values (1,'admin','$2y$13$b1WxtdvYxahN2UfXaRJZpeeldHxjIpoWmK3C6tGrNKU21ryhMMsyC','7Jug3PANyCsxKzq4-NSalkAbwm1vTBEN');
